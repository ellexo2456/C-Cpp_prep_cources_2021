...
void write_to_file_blackrecord(FILE *pointer_to_file_record, FILE *pointer_to_file_transaction, FILE *pointer_to_file_blackrecord, data client_data, data transfer) {
